...
python train.py \
--save_name trsf_bbTinyimg_fsrCifar10_resnet18 --dataset tinyimg --model resnet18 --device 4 --epoch 20 \
...
python train.py \
--save_name trsf_bbTinyimg_fsrCifar100_resnet18 --dataset tinyimg --model resnet18 --device 4 --epoch 20 \
...
# TinyImageNet -> MNIST
python train.py \
--save_name trsf_bbTinyimg_fsrMNIST_resnet18 --dataset tinyimg --model resnet18 --device 4 --epoch 20 \
...
# TinyImageNet -> SVHN
python train.py \
--save_name trsf_bbTinyimg_fsrSVHN_resnet18 --dataset tinyimg --model resnet18 --device 4 --epoch 20 \
...
python train.py \
--save_name trsf_bbTinyimg_fsrTinyimg_resnet18 --dataset tinyimg --model resnet18 --device 4 --epoch 20 \
