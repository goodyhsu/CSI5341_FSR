...
# SVHN -> CIFAR10
python train.py \
--save_name trsf_bbSVHN_fsrCifar10_resnet18 --dataset svhn --model resnet18 --device 3 --epoch 20 \
...
# SVHN -> CIFAR100
python train.py \
--save_name trsf_bbSVHN_fsrCifar100_resnet18 --dataset svhn --model resnet18 --device 3 --epoch 20 \
...
# SVHN -> MNIST
python train.py \
--save_name trsf_bbSVHN_fsrMNIST_resnet18 --dataset svhn --model resnet18 --device 3 --epoch 20 \
...
# SVHN -> SVHN
python train.py \
--save_name trsf_bbSVHN_fsrSVHN_resnet18 --dataset svhn --model resnet18 --device 3 --epoch 20 \
...
# SVHN -> TinyImageNet
python train.py \
--save_name trsf_bbSVHN_fsrTinyimg_resnet18 --dataset svhn --model resnet18 --device 3 --epoch 20 \
