...
# CIFAR100 -> CIFAR10
python train.py \
--save_name trsf_bbCifar100_fsrCifar10_resnet18 --dataset cifar100 --model resnet18 --device 1 --epoch 100 \
...
# CIFAR100 -> CIFAR100
python train.py \
--save_name trsf_bbCifar100_fsrCifar100_resnet18 --dataset cifar100 --model resnet18 --device 1 --epoch 100 \
...
# CIFAR100 -> MNIST
python train.py \
--save_name trsf_bbCifar100_fsrMNIST_resnet18 --dataset cifar100 --model resnet18 --device 1 --epoch 100 \
...
# CIFAR100 -> SVHN
python train.py \
--save_name trsf_bbCifar100_fsrSVHN_resnet18 --dataset cifar100 --model resnet18 --device 1 --epoch 100 \
...
python train.py \
--save_name trsf_bbCifar100_fsrTinyimg_resnet18 --dataset cifar100 --model resnet18 --device 1 --epoch 100 \
