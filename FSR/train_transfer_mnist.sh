...
# MNIST -> CIFAR10
python train.py \
--save_name trsf_bbMNIST_fsrCifar10_resnet18 --dataset mnist --model resnet18 --device 2 --epoch 100 \
...
# MNIST -> CIFAR100
python train.py \
--save_name trsf_bbMNIST_fsrCifar100_resnet18 --dataset mnist --model resnet18 --device 2 --epoch 100 \
...
# MNIST -> MNIST
python train.py \
--save_name trsf_bbMNIST_fsrMNIST_resnet18 --dataset mnist --model resnet18 --device 2 --epoch 100 \
...
# MNIST -> SVHN
python train.py \
--save_name trsf_bbMNIST_fsrSVHN_resnet18 --dataset mnist --model resnet18 --device 2 --epoch 100 \
...
# MNIST -> TinyImageNet
python train.py \
--save_name trsf_bbMNIST_fsrTinyimg_resnet18 --dataset mnist --model resnet18 --device 2 --epoch 100 \
