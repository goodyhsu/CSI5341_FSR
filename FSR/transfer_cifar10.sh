...
# CIFAR10 -> CIFAR10
python train.py \
--save_name trsf_bbCifar10_fsrCifar10_resnet18 --dataset cifar10 --model resnet18 --device 0 --epoch 20 \
...
# CIFAR10 -> CIFAR100
python train.py \
--save_name trsf_bbCifar10_fsrCifar100_resnet18 --dataset cifar10 --model resnet18 --device 0 --epoch 20 \
...
# CIFAR10 -> MNIST
python train.py \
--save_name trsf_bbCifar10_fsrMNIST_resnet18 --dataset cifar10 --model resnet18 --device 0 --epoch 20 \
...
# CIFAR10 -> SVHN
python train.py \
--save_name trsf_bbCifar10_fsrSVHN_resnet18 --dataset cifar10 --model resnet18 --device 0 --epoch 20 \
...
python train.py \
--save_name trsf_bbCifar10_fsrTinyimg_resnet18 --dataset cifar10 --model resnet18 --device 0 --epoch 20 \
